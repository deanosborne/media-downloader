...
import { IConfigStorage } from '../types.js';
...
describe('ConfigManager', () => {
  ...
  describe('initialization', () => {
    ...
    it('should load default values during initialization', async () => {
      ...
      const tmdbBaseUrl = configManager.get<string>('tmdb.baseUrl');
  ...
  describe('get and set operations', () => {
    it('should get and set configuration values', async () => {
      ...
      const apiKey = configManager.get<string>('tmdb.apiKey');
    ...
    it('should throw error for required keys that are not set', () => {
      expect(() => configManager.getRequired('tmdb.apiKey')).toThrow(
        "Required configuration key 'tmdb.apiKey' is not set"
      );
    });
    ...
    it('should return required values when they exist', async () => {
      ...
      const apiKey = configManager.getRequired<string>('tmdb.apiKey');
  ...
  describe('error handling', () => {
    it('should throw error when accessing uninitialized manager', () => {
      ...
      expect(() => uninitializedManager.get('test.key')).toThrow(
        'ConfigManager must be initialized before use'
      );
    });
